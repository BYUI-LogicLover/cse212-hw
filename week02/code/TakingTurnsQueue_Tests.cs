...
public class TakingTurnsQueueTests
{
    ...
    //                  which added people to the front instead of the back, breaking FIFO order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: (1) PersonQueue.Enqueue used Insert(0, person) instead of Add(person),
    //                  breaking FIFO order. (2) GetNextPerson did not re-enqueue people with
    //                  turns=0 (infinite turns) - they were removed from the queue after one turn.
    ...
    // Defect(s) Found: None - this functionality worked correctly.
